"""
End-to-end tests for splent_feature_comments.
...
Run with:  splent feature:test splent_feature_comments --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_comments")
    assert "splent_feature_comments" in browser.page_source.lower()
